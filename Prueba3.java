...
public class Prueba3 {
	...
	void prueba1Funcion3() {
		assertEquals(39,  funcioness.Entornos3(new int[] {10,11 ,18}));
	...
	void prueba2Funcion3() {
		assertEquals(0,  funcioness.Entornos3(new int[] {0,0 ,0}));
	...
	void prueba4Funcion3() {
		assertEquals(18,  funcioness.Entornos3(new int[] {18,20,21}));
